...
const Icon = ({ name, size = 16, stroke = 1.6 }) => {
  ...
  switch (name) {
    ...
    case 'pin':
      return (
        <svg {...props}>
          <path d="M12 17v5M9 9l-3 3 6 0M9 9l4-4 4 4-4 4M9 9l4 4" />
        </svg>
      );
    case 'lock':
      return (
    ...
    case 'unlock':
      return (
        <svg {...props}>
          <rect x="4" y="11" width="16" height="10" rx="2" />
          <path d="M8 11V8a4 4 0 0 1 7.5-3" />
          <path d="M18 5l-3 3" />
        </svg>
      );
    case 'medal':
      return (
        <svg {...props}>
          <path d="M8 4l1 5 3 1-3 1-1 5-2.5-4L3 16l1-5-1-5 4-2z" />
          <path d="M16 4l-1 5-3 1 3 1 1 5 2.5-4L21 16l-1-5 1-5-4-2z" />
        </svg>
      );
    case 'flag':
      return (
        <svg {...props}>
          <path d="M5 2v20" />
          <path d="M5 3h11l-1.5 4L16 11H5z" />
        </svg>
      );
    case 'pin':
      return (
    ...
    case 'flame':
      return (
        <svg {...props}>
          <path d="M12 3s5 4 5 9a5 5 0 0 1-10 0c0-2 1-3 2-4-1 4 3 2 3 5 0-3 2-4 0-10z" />
        </svg>
      );
    case 'check':
      return (
    ...
    case 'tag':
      return (
        <svg {...props}>
          <path d="M20 12l-9 9-8-8 9-9h8v8z" />
    ...
    case 'spark':
      return (
        <svg {...props}>
          <path
            d="M12 3l1.5 5L19 9.5 13.5 11 12 16l-1.5-5L5 9.5 10.5 8z"
            fill="currentColor"
            stroke="none"
          />
        </svg>
    ...
    case 'handshake':
      return (
        <svg {...props}>
          <path d="M3 12l4-5 4 2 4-2 6 5" />
          <path d="M21 12l-5 6-3-2-3 2-5-6" />
        </svg>
      );
    case 'chat':
      return (
        <svg {...props}>
          <path d="M21 12a8 8 0 1 1-3-6L21 4l-1 4a8 8 0 0 1 1 4z" />
        </svg>
      );
    case 'mic':
      return (
    ...
    case 'users':
      return (
        <svg {...props}>
          ...
          <path d="M2 20c0-3 3-5 7-5s7 2 7 5M14 19c0-2 2-3.5 5-3.5s5 1.5 5 3.5" />
        </svg>
      );
    case 'play':
      return (
    ...
    case 'sparkles':
      return (
        <svg {...props}>
          <path
            d="M12 3l1 4 4 1-4 1-1 4-1-4-4-1 4-1zM19 13l.5 2 2 .5-2 .5-.5 2-.5-2-2-.5 2-.5zM5 15l.5 2 2 .5-2 .5-.5 2-.5-2-2-.5 2-.5z"
            fill="currentColor"
            stroke="none"
          />
        </svg>
    ...
    case 'gift':
      return (
        <svg {...props}>
          ...
          <path d="M3 13h18M12 9v12M8 9a3 3 0 1 1 4-3M16 9a3 3 0 1 0-4-3" />
        </svg>
      );
    case 'image':
      return (
  ...
  return (
    <div className="avatar-stack" style={{ display: 'flex' }}>
      {shown.map((h, i) => (
        <div
          key={h}
          style={{ marginLeft: i === 0 ? 0 : -8, position: 'relative', zIndex: max - i }}
        >
...
const TierBadge = ({ tier }) => {
  ...
  return (
    <span className="tier-badge" style={{ color: s.c, background: s.bg }}>
      {tier}
    </span>
  );
};

...
const USERS = [
  {
    ...
    kp: 5200,
    joined: '2024-03-10',
    bio: 'Smart contract auditor with 6 years in DeFi security.',
    loc: 'Nairobi, KE',
    avatar: 'A',
    hue: 260,
  },
  {
    ...
    kp: 7800,
    joined: '2024-02-01',
    bio: 'Full-stack engineer building on Solana and EVM chains.',
    loc: 'Lagos, NG',
    avatar: 'F',
    hue: 150,
  },
  {
    ...
    kp: 3100,
    joined: '2024-05-20',
    bio: 'Motion designer helping Web3 projects tell better stories.',
    loc: 'Addis Ababa, ET',
    avatar: 'Z',
    hue: 340,
  },
  {
    ...
    kp: 72,
    joined: '2026-08-01',
    bio: 'Demo account for Compass onboarding.',
    loc: 'Remote',
    avatar: 'H',
    hue: 190,
  },
...
const userByHandle = (h) => {
  ...
  return (
    PROFILE_CACHE[h] ||
    USERS.find((u) => u.handle === h) || {
      handle: h,
      name: h,
      avatar: h[0].toUpperCase(),
      hue: 215,
      tier: 'Explorer',
      kp: 0,
      bio: '',
...
const fetchUserByHandle = async (h) => {
  const sess = window.supabaseService?.getSession();
  const sb = sess?.access_token && !sess?.local ? window.supabaseService : null;
...
const TOPICS = [
  {
    id: 'market-momentum',
    cat: 'news',
    title: 'Africa crypto markets heat up after regulatory clarity',
    author: 'felix',
    tags: ['crypto', 'africa'],
    replies: 34,
    views: 142,
    participants: ['amara', 'zara'],
    lastActivity: '2h ago',
    pinned: true,
    hot: true,
    validated: true,
  ...
  },
  {
    id: 'audit-standards',
    cat: 'alpha',
    title: 'Why audits should be standard for every token launch',
    author: 'amara',
    tags: ['security', 'audit'],
    replies: 18,
    views: 89,
  ...
  },
  {
    id: 'creator-token',
    cat: 'partnership',
    title: 'How creator tokens can unlock community ownership',
    author: 'zara',
    tags: ['creator', 'tokenomics'],
    replies: 22,
    views: 76,
    participants: ['felix'],
    lastActivity: '8h ago',
  ...
  },
  {
    id: 'training-hack',
    cat: 'training',
    title: 'Bootcamp graduates share the most valuable Web3 learnings',
    author: 'amara',
    tags: ['learning', 'community'],
    replies: 14,
    views: 52,
    participants: ['felix', 'zara'],
...
const SUGGESTED_USERS = [
  { id: 'u1', handle: 'amara', name: 'Amara Osei', avatar: 'A', hue: 260, tier: 'Wayfinder' },
  { id: 'u2', handle: 'felix', name: 'Felix Nwosu', avatar: 'F', hue: 150, tier: 'Trailblazer' },
  { id: 'u3', handle: 'zara', name: 'Zara Haile', avatar: 'Z', hue: 340, tier: 'Navigator' },
];

const EVENTS_UPCOMING = [
  {
    id: 'e1',
    title: 'Smart contract security AMA',
    sub: 'Ask top auditors about on-chain risk and audits.',
    date: 'June 12 · 4:00 PM WAT',
    going: 86,
    tag: 'Now',
    kind: 'AMA',
    from: 0.1,
  ...
  },
  {
    ...
    sub: 'Launch your first token economy in 60 minutes.',
    date: 'June 14 · 11:00 AM GMT',
    going: 132,
    tag: 'Workshop',
    kind: 'Live',
    from: 0.2,
  ...
  {
    id: 'e3',
    title: 'DAOs for African creators',
    sub: 'Design governance that rewards your community.',
    date: 'June 16 · 6:00 PM SAST',
    going: 54,
    tag: 'Roundtable',
    kind: 'Event',
    from: 0.15,
...
const ONLINE_MEMBERS = [
  { handle: 'amara', name: 'Amara Osei', avatar: 'A', hue: 260 },
  { handle: 'felix', name: 'Felix Nwosu', avatar: 'F', hue: 150 },
  { handle: 'zara', name: 'Zara Haile', avatar: 'Z', hue: 340 },
  { handle: 'nina', name: 'Nina K.', avatar: 'N', hue: 45 },
  { handle: 'tunde', name: 'Tunde B.', avatar: 'T', hue: 80 },
  { handle: 'ade', name: 'Ade O.', avatar: 'D', hue: 190 },
];
...
const CONVERSATIONS = [
  {
    id: 'convo_1',
    participants: ['amara', 'felix'],
    last_message: 'Looking forward to the workshop!',
    last_when: '2m ago',
    unread: 1,
  },
  {
    id: 'convo_2',
    participants: ['zara', 'amara'],
    last_message: 'Perfect, thanks. I’ll review it after lunch.',
    last_when: 'Yesterday',
    unread: 0,
  },
  {
    id: 'convo_3',
    participants: ['honoredhash', 'felix'],
    last_message: 'Yes! I’ll be there. Need help with the prep slide?',
    last_when: '7m ago',
    unread: 0,
  },
];
...
const MESSAGES_BY_CONVO = {
  convo_1: [
    {
      id: 'msg_1',
      sender_handle: 'amara',
      body: 'Hi Felix, are you joining the workshop tonight?',
    ...
    },
    {
      id: 'msg_2',
      sender_handle: 'felix',
      body: 'Yes! I’ll be there. Need help with the prep slide?',
  ...
  convo_2: [
    {
      id: 'msg_3',
      sender_handle: 'zara',
      body: 'I shared the design deck in the studio channel.',
    ...
    },
    {
      id: 'msg_4',
      sender_handle: 'amara',
      body: 'Perfect, thanks. I’ll review it after lunch.',
  ...
  convo_3: [
    ...
    },
    {
      id: 'msg_6',
      sender_handle: 'felix',
      body: 'That sounds great — I can help you polish the narrative.',
...
const CONTENT_ITEMS = [
  {
    id: 'c1',
    kind: 'article',
    title: 'How to build on-chain communities in Africa',
    author: 'felix',
    when: '3 days ago',
    minutes: 6,
    bg: 'navy',
  },
  {
    id: 'c2',
    kind: 'resource',
    title: 'A beginner guide to ZK proofs for builders',
    author: 'amara',
    when: 'Yesterday',
    minutes: 5,
    bg: 'forest',
  },
  {
    id: 'c3',
    kind: 'case study',
    title: 'How this DAO launched a $50K grant round in 7 days',
    author: 'zara',
    when: '2 days ago',
    minutes: 8,
    bg: 'royal',
...
const messageService = {
  _sb() {
    const sess = window.supabaseService?.getSession();
    return sess?.access_token && !sess?.local ? window.supabaseService : null;
  },
  ...
  async sendMessage({ conversationId, body }) {
    ...
    const msg = {
      ...
      sender_handle: window.currentUser?.handle || 'me',
      body: text,
  ...
  async createConversation({ participantHandles }) {
    ...
    const convo = { id, participants, last_message: '', last_when: 'just now', unread: 0 };
...
const readApprovedTalents = () => {
  try {
    return JSON.parse(localStorage.getItem(TALENT_KEY_APPROVED) || '[]');
  } catch {
    return [];
  }
};
...
const writeApprovedTalents = (list) => {
  try {
    localStorage.setItem(TALENT_KEY_APPROVED, JSON.stringify(list));
  } catch {}
};
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.6,
        desc: 'Quick assessment for small contracts (< 500 LOC).',
        features: ['Manual review', 'Automated analysis', 'Summary report', '1 re-audit round'],
        delivery: '3 days',
      ...
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: 'Full audit for production contracts (< 3000 LOC).',
        features: [
          'Manual review',
          'Automated analysis',
          'Detailed report with severity',
      ...
      },
      {
        ...
        name: 'Premium',
        priceMul: 1.8,
        desc: 'Deep-dive with fuzzing + formal verification.',
        features: [
          'Everything in Standard',
          'Fuzzing with Echidna',
          'Formal verification (Certora)',
          'Priority support',
          'Post-deploy monitoring 30d',
        ],
        delivery: '14 days',
    ...
    reviewList: [
      {
        ...
        when: '2 weeks ago',
        rating: 5,
        body: 'Amara caught a critical reentrancy bug our team missed. Saved us from a major incident. Highly recommend.',
      },
      {
        who: 'amara',
        when: '1 month ago',
        rating: 5,
        body: 'Thorough and fast. The report was well-structured with clear remediation steps.',
      },
    ],
  },
  {
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: 'MVP with one smart contract + basic frontend.',
        features: [
          '1 smart contract (ERC-20/721)',
      ...
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: 'Production dApp with full frontend + tests.',
        features: [
          '2-3 smart contracts',
          'Production React UI',
      ...
      },
      {
        ...
        name: 'Premium',
        priceMul: 1.7,
        desc: 'Full mainnet launch + subgraph + monitoring.',
        features: [
          'Everything in Standard',
          'The Graph subgraph',
          'Mainnet deploy',
          'Post-launch monitoring 2w',
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: 'Logo + colour palette + typography guide.',
        features: ['3 logo concepts', 'Colour palette', 'Typography guide', 'Source files'],
        delivery: '5 days',
        revisions: '2 revisions',
        popular: false,
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: 'Full identity: logo, brand guide, social kit, basic motion.',
        features: [
          'Everything in Basic',
          'Full brand guide PDF',
          'Social media kit',
          '1 animated Lottie asset',
        ],
        delivery: '10 days',
        revisions: '3 revisions',
        popular: true,
      },
      {
        ...
        name: 'Premium',
        priceMul: 1.8,
        desc: 'Complete brand + UI kit + multi-scene motion pack.',
        features: [
          'Everything in Standard',
          'Figma UI kit (20+ screens)',
          '5 animated Lottie assets',
          'Brand video intro (15s)',
        ],
        delivery: '21 days',
        revisions: '4 revisions',
        popular: false,
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: '5 Twitter threads + 1 article per week.',
        features: ['5 threads/week', '1 article/week', 'Content calendar', 'Basic analytics'],
        delivery: '7 days',
        revisions: '2 revisions',
        popular: false,
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: '10 threads + 2 articles + newsletter setup.',
        features: [
          '10 threads/week',
          '2 articles/week',
          'Newsletter setup',
      ...
      },
      {
        ...
        name: 'Premium',
        priceMul: 1.7,
        desc: 'Full content machine + distribution + PR.',
        features: [
          'Everything in Standard',
          'PR outreach (5 outlets)',
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: 'Governance framework + Snapshot setup.',
        features: [
          'Governance framework doc',
          'Snapshot space setup',
          'Voting strategy config',
          'Setup guide',
        ],
        delivery: '5 days',
        revisions: '1 revision',
      ...
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: 'Full governance + proposal management + 1 month support.',
        features: [
          'Everything in Basic',
          'Proposal templates',
          'Community onboarding',
          '1 month proposal support',
        ],
        delivery: '10 days',
        revisions: '2 revisions',
        popular: true,
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: '60s explainer video with stock assets.',
        features: ['Scriptwriting', 'Stock assets', 'Voiceover', '1 revision round'],
        delivery: '7 days',
        revisions: '1 revision',
        popular: false,
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: '90s custom-animated explainer with original assets.',
        features: [
          'Everything in Basic',
          'Custom animation',
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: 'Growth audit + 30-day action plan.',
        features: ['Growth audit', '30-day action plan', 'Competitor analysis', '1 check-in call'],
        delivery: '5 days',
        revisions: '1 revision',
        popular: false,
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: 'Full growth campaign (30 days).',
        features: [
          'Campaign strategy',
    ...
    packages: [
      {
        ...
        name: 'Basic',
        priceMul: 0.5,
        desc: 'Protocol overview report (5-10 pages).',
        features: ['Executive summary', 'Tech overview', 'Tokenomics analysis', 'PDF delivery'],
        delivery: '7 days',
        revisions: '1 revision',
        popular: false,
      },
      {
        ...
        name: 'Standard',
        priceMul: 1.0,
        desc: 'Full research report (20-30 pages) with competitive analysis.',
        features: [
          'Everything in Basic',
...
const talentService = {
  ...
  _persist() {
    try {
      localStorage.setItem(this._key, JSON.stringify(TALENT));
    } catch {}
  },
  ...
  _canUpdate(gig, u) {
    return u && (this._isAdmin(u) || u.handle === gig.author);
  },
  _canDelete(u) {
    return this._isAdmin(u);
  },

  async create(data, currentUser) {
    if (!this._canCreate(currentUser)) {
      const approved = readApprovedTalents();
      if (approved.includes(currentUser.handle))
        throw new Error('Your talent account is approved. You can post gigs.');
  ...
  async update(id, changes, currentUser) {
    const sb = this._sb();
    if (sb) {
      return sb.updateTalent(id, changes);
    }
    const gig = TALENT.find((t) => t.id === id);
    if (!gig) throw new Error('Gig not found.');
    if (!this._canUpdate(gig, currentUser))
      throw new Error('Only the talent, admins, and moderators can edit this gig.');
  ...
  async delete(id, currentUser) {
    const sb = this._sb();
    if (sb) {
      await sb.deleteTalent(id);
      return true;
    }
    const idx = TALENT.findIndex((t) => t.id === id);
    if (idx === -1) throw new Error('Gig not found.');
    if (!this._canDelete(currentUser))
      throw new Error('Only admins and moderators can delete gigs.');
    TALENT.splice(idx, 1);
    this._persist();
    return true;
  },
  ...
  async setFeatured(id, on, currentUser) {
    if (!this._isAdmin(currentUser))
      throw new Error('Only admins and moderators can set featured status.');
    const sb = this._sb();
    if (sb) {
      return sb.setTalentFeatured(id, on);
    }
    const gig = TALENT.find((t) => t.id === id);
    if (!gig) throw new Error('Gig not found.');
    gig.featured = !!on;
  ...
  async approveTalent(handle, currentUser) {
    if (!this._isAdmin(currentUser))
      throw new Error('Only admins and moderators can approve talents.');
    const approved = readApprovedTalents();
  ...
  async revokeTalent(handle, currentUser) {
    if (!this._isAdmin(currentUser))
      throw new Error('Only admins and moderators can revoke talent status.');
...
const canCreateEvent = (user) =>
  user && (CAN_CREATE_ROLES.includes(user.role) || CAN_HOST_TIERS.includes(user.tier));
...
const CONFERENCES = [
  {
    id: 'cls_1',
    title: 'Build in public workshop',
    desc: 'Launch your first token economy in 60 minutes with live coaching and playbook review.',
    host: 'felix',
    cohosts: ['zara'],
    status: 'scheduled',
    when: 'June 14 · 11:00 AM GMT',
    capacity: 80,
    registered: 32,
    durationMin: 45,
    cover: 220,
  ...
  },
  {
    id: 'cls_2',
    title: 'Smart contract security AMA',
    desc: 'Ask top auditors about on-chain risk, audits, and best practices for launch.',
    host: 'amara',
    cohosts: [],
    status: 'live',
    when: 'Live now',
  ...
  },
  {
    id: 'cls_3',
    title: 'DAOs for African creators',
    desc: 'Design governance that rewards your community and funds creative projects.',
    host: 'zara',
    cohosts: [],
    status: 'ended',
    when: 'Replay available',
    capacity: 70,
    registered: 64,
    attended: 48,
    attending: 48,
...
const conferenceService = {
  ...
  _persist() {
    try {
      localStorage.setItem(this._key, JSON.stringify(CONFERENCES));
    } catch {}
  },
  ...
  async update(id, changes) {
    const sb = this._sb();
    if (sb) {
      await sb.updateConference(id, changes);
      return this._normConference(await sb.getConference(id));
    }
  ...
  async end(id) {
    ...
    return this.update(id, {
      status: 'ended',
      attended: CONFERENCES.find((c) => c.id === id)?.registered || 0,
    });
  },
...
const readKpLog = () => {
  try {
    return JSON.parse(localStorage.getItem(KP_LOG_KEY)) || {};
  } catch {
    return {};
  }
};
...
const QUESTS_TEMPLATE = [
  {
    ...
    icon: 'news',
    label: 'Read 3 posts',
    desc: 'Read three topics in any category',
    kp: 10,
  },
  {
    id: 'q_reply',
    icon: 'chat',
    label: 'Reply to a topic',
    desc: 'Contribute to a discussion thread',
    kp: 5,
  },
  {
    id: 'q_profile',
    ...
    desc: 'Check your dashboard and KP summary',
    kp: 3,
  },
  {
    id: 'q_space',
    icon: 'mic',
    label: 'React in a Space',
    desc: 'Drop an emoji reaction in a live room',
    kp: 5,
  },
  {
    id: 'q_quest',
    icon: 'spark',
    label: 'Complete all quests',
    desc: 'Finish every quest on this list',
    kp: 15,
  },
];
  ...
  async complete(id) {
    ...
    try {
      localStorage.setItem(
        this._key,
        JSON.stringify({ date: new Date().toDateString(), list: QUESTS }),
      );
    } catch {}
    return true;
  },
...
const spaceService = {
  ...
  _persist() {
    try {
      localStorage.setItem(this._key, JSON.stringify(SPACES));
    } catch {}
  },
  ...
  _normSpace(raw) {
    ...
    if (typeof s.cohosts === 'string') {
      try {
        s.cohosts = JSON.parse(s.cohosts);
      } catch {
        s.cohosts = [];
      }
    ...
    if (typeof s.speakers === 'string') {
      try {
        s.speakers = JSON.parse(s.speakers);
      } catch {
        s.speakers = [];
      }
  ...
  async update(id, changes) {
    const sb = this._sb();
    if (sb) {
      await sb.updateSpace(id, changes);
      return this._normSpace(await sb.getSpace(id));
    }
...
window.__notifRefresh = async () => {
  ...
  if (!sb) return;
  try {
    const [notifs, count] = await Promise.all([sb.getNotifications(), sb.getUnreadCount()]);
...
async function refreshSocial() {
  ...
  if (!session?.access_token || session.local) return;
  try {
    ...
    if (Array.isArray(convos)) {
      ...
      window.dispatchEvent(new Event('compass_conversations_refresh'));
    }
    if (Array.isArray(suggested)) {
      SUGGESTED_USERS.length = 0;
      SUGGESTED_USERS.push(...suggested);
    }
    if (Array.isArray(trending)) {
      TRENDING_TAGS.length = 0;
      TRENDING_TAGS.push(...trending);
    }
  } catch {}
}
